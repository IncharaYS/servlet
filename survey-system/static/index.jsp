    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="nav">
            <ul class="navbar-nav ms-auto fs-5">
                ...
                <li class="nav-item"><a class="nav-link text-white" href="survey">Take Survey</a></li>
            </ul>
        </div>
    </div>
</nav>
...
<div class="container d-flex flex-column justify-content-center align-items-center vh-80 pt-5">
    ...
    <div class="d-flex flex-column gap-2 w-50 ">
        <a href="survey" class=" btn btn-light p-3 border-2 border-primary rounded "><h5 class="text-primary">Survey Form</h5></a>
    </div>
